...
def main():
    ...
    if remaining_trials <= 0:
        ...
        if args.study_type == "ARCHITECTURE":
            ...
            model_params = base_study.best_trial.params
            ...
            if args.study_type == "REGULARISATION":
                model_path = MODEL_DIR / "regularised" / f"{args.model_type_name}.pt"
                trial_function = ft.partial(
                ...
                model_path = MODEL_DIR / base_model_type / f"{args.model_type_name}.pt"
                trial_function = ft.partial(
                    optimise_weights,
                    dataset=dataset,
                    model_params=model_params,
