...
The data required for this study is made publicly available by the UK government via Companies House. Additional processing and entity resolution is applied to UK Persons of Significant Control (PSC) data by the Open Corporates organisation, and so PSC data is extracted from their own database. A summary of the data requirements is presented below.
